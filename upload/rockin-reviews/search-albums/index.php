        ...
        <div class="album-container">
            ...
            if (isset($_GET["searchId"])) {
                if ($_GET['searchId'] == '') {
                    ...
                    showSearchedAlbumArtistAPI($searchId);
                }
            }
            ?>
        </div>
        ...
        <div class="album-container">
            ...
            if (isset($_GET["searchId"])) {
                if ($_GET['searchId'] == '') {
                    ...
                    showSearchedAlbumAlbumAPI($searchId);
                }
            }
            ?>
        </div>
        ...
        <div class="album-container">
            ...
            if (isset($_GET["searchId"])) {
                if ($_GET['searchId'] == '') {
                    ...
                    showSearchedAlbumGenreAPI($searchId);
                }
            }
            ?>
        ...
        <div class="album-container">
            ...
            if (isset($_GET["searchId"])) {
                if ($_GET['searchId'] == '') {
                    ...
                    showSearchedAlbumSubGenreAPI($searchId);
                }
            }
            ?>
        </div>
        ...
        <div class="album-container">
            ...
            if (isset($_GET["searchId"])) {
                if ($_GET['searchId'] == '') {
                    ...
                    showSearchedAlbumYearAPI($searchId);
                }
            }
            ?>
        </div>
